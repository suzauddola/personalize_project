...
"""
file_path = "D:/ResearchData/phd_research/dataset/tea_tree_oil/original_with_downloaded_images/Anomala corpulenta/"
# file_path = "D:/ResearchData/phd_research/Project/download_using_python/google-images-download-master/images/anomala_corpulenta/"
# file_path = "D:/ResearchData/phd_research/Project/download_using_python/google-images-download-master/images/anomala_corpulenta/"
...
def compare_images(directory, show_imgs=True, similarity="high", compression=50):
    ...
    # os.remove(file_path+compared_img)

    for dup_file in duplicates:
        os.remove(file_path + dup_file)
